package fr.junade.gainznote.ui.theme
...
// ─── Superset color helpers (SS1=violet, SS2=orange, SS3=kaki, cyclic) ────────

private val SUPERSET_COLORS = listOf(
    Color(0xFF9B59B6), // SS1 violet
    Color(0xFFE67E22), // SS2 orange
    Color(0xFF7D8C3E)  // SS3 kaki
)
private val SUPERSET_COLORS_DIM = listOf(
    Color(0x229B59B6),
    Color(0x22E67E22),
    Color(0x227D8C3E)
)
fun supersetColor(index: Int): Color = SUPERSET_COLORS[(index - 1).coerceAtLeast(0) % SUPERSET_COLORS.size]
fun supersetColorDim(index: Int): Color = SUPERSET_COLORS_DIM[(index - 1).coerceAtLeast(0) % SUPERSET_COLORS_DIM.size]

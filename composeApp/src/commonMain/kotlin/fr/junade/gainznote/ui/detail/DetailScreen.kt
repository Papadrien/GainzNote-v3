package fr.junade.gainznote.ui.detail
...
import fr.junade.gainznote.ui.history.StatChip
import fr.junade.gainznote.ui.history.WorkoutStatsRow
...
fun DetailScreen(
    ...
    // Couleurs adaptées au type de l'entraînement visualisé
    val c = GainzThemeColors(darkTheme, type = workout?.type ?: fr.junade.gainznote.model.WorkoutType.MUSCULATION)
...
fun ExerciseDetailCard(exercise: Exercise, c: GainzThemeColors) {
    val isSuperset = exercise.supersetGroup != null
